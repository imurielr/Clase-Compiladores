...
public class DyckParser {
   ...
   public DyckAbs parser()
      ...
      do {
         ...
         // System.out.println("cc: " + cc + " top: " + gs);
         ...
         if (gs instanceof PilotState) {
            ...
            try {
               ...
               if (nps != null) {
                  ...
                  // System.out.println("cc: " + cc + " top: "+ stack.peek());
               }
               else {
               ...
               // Busca luego si es un estado de reducción
               // System.out.println("Reducción cc: " + cc + " top: " + gs);
               ...
               // System.out.println("Production lhs: " + nt + " rhs: " + gss);
